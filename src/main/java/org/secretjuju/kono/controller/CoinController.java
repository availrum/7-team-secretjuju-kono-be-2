...
public class CoinController {
	...
	@ApiResponses(value = {
		@ApiResponse(
			...
			content = @Content(
				...
				examples = @ExampleObject(value = "{\"success\": true, \"message\": \"코인 목록 조회 성공\", \"data\": []}")
			)
		),
		@ApiResponse(
			responseCode = "401",
	...
	@ApiResponses(value = {
		@ApiResponse(
			...
			content = @Content(
				schema = @Schema(implementation = String.class),
				examples = @ExampleObject(value = "{\"success\": true, \"message\": \"코인 상세 정보 조회 성공\", \"data\": {}}")
			)
		),
		@ApiResponse(
			responseCode = "401",
		...
		@ApiResponse(
			responseCode = "404",
			description = "코인 정보 없음",
			content = @Content(
				schema = @Schema(implementation = String.class),
				examples = @ExampleObject(value = "{\"success\": false, \"message\": \"코인 정보 없음\"}")
			)
		),
		@ApiResponse(
			responseCode = "500",
