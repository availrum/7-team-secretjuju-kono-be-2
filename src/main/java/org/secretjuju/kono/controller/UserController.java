...
public class UserController {
	...
	@ApiResponses(value = {
		@ApiResponse(
			...
			content = @Content(
				...
				examples = @ExampleObject(value = "{\"success\": true, \"message\": \"회원 정보 조회 성공\", \"data\": {}}")
			)
		),
		@ApiResponse(
			responseCode = "401",
	...
	@ApiResponses(value = {
		@ApiResponse(
			responseCode = "201",
			description = "관심 코인 추가 성공",
			content = @Content(
				schema = @Schema(implementation = Map.class),
				examples = @ExampleObject(value = "{\"success\": true, \"message\": \"관심 코인 추가 성공\", \"data\": {}}")
			)
		),
		@ApiResponse(
			responseCode = "400",
	...
	@ApiResponses(value = {
		@ApiResponse(
			...
			content = @Content(
				schema = @Schema(implementation = Map.class),
				examples = @ExampleObject(value = "{\"success\": true, \"message\": \"뱃지 목록 조회 성공\", \"data\": {}}")
			)
		),
		@ApiResponse(
			responseCode = "401",
	...
	@ApiResponses(value = {
		@ApiResponse(
			...
			content = @Content(
				schema = @Schema(implementation = Map.class),
				examples = @ExampleObject(value = "{\"success\": true, \"message\": \"프로필 이미지 변경 성공\", \"data\": {}}")
			)
		),
		@ApiResponse(
			responseCode = "404",
			...
			content = @Content(
				schema = @Schema(implementation = Map.class),
				examples = @ExampleObject(value = "{\"success\": false, \"message\": \"프로필 이미지 없음\"}")
			)
		),
		@ApiResponse(
			responseCode = "500",
	...
	@ApiResponses(value = {
		@ApiResponse(
			...
			content = @Content(
				schema = @Schema(implementation = Map.class),
				examples = @ExampleObject(value = "{\"success\": true, \"message\": \"닉네임 변경 성공\", \"data\": {}}")
			)
		),
		@ApiResponse(
			responseCode = "400",
			...
			content = @Content(
				schema = @Schema(implementation = Map.class),
				examples = @ExampleObject(value = "{\"success\": false, \"message\": \"닉네임 중복\"}")
			)
		),
		@ApiResponse(
			responseCode = "401",
		...
		@ApiResponse(
			...
			content = @Content(
				schema = @Schema(implementation = Map.class),
				examples = @ExampleObject(value = "{\"success\": false, \"message\": \"닉네임 이미 사용 중\"}")
			)
		),
		@ApiResponse(
			responseCode = "500",
